...
class socket:
        ...
        if (len(args) >= 2):
            if (args[1] == ENCRYPT):
                ...
                if address in publicKeys and privateKeys:   
                    ...
                    print('Connect Encryption Failed')
                    return
    ...
    def accept(self,*args):
        ...
        self.ack_no = syn_packet[PACKET_SEQUENCE_NO_INDEX] + 1
    ...
    def recv(self,nbytes):
        ...
        while bytes_to_receive > 0:
            ...
            try:
                ...
                packet_received = self.socket.recv(PACKET_HEADER_LENGTH + MAXIMUM_PACKET_SIZE)
                ...
                if str_received is not None:
                    ...
                    #print(len(str_received), bytes_to_receive)
    ...
    def manage_recvd_data_packet(self, packet):
        ...
        print((packet_header[PACKET_SEQUENCE_NO_INDEX], self.ack_no))
